...
vars_to_keep <- c(
  ...
  "porftvg3intake",  #Intake used in 2024 data 
  "porftvg3intake_ui",  #Intake_ui (usual intake method) used in 2021: SG updated this var to match the usual intake method used from 2024. 
