...
extracted_survey_data_shs <- extract_survey_data("shs", phy = TRUE) 
# takes ~ 3 mins 
...
extract_responses(survey = "shs", #survey acronym
                  chars_to_exclude = c("_wt"), phy = TRUE) 
...
# 
# $council
# [1] "aberdeen city"       "north ayrshire"      "aberdeenshire"       "dumfries & galloway" "fife"                "edinburgh, city of"  "south ayrshire"      "clackmannanshire"    "falkirk"             "perth & kinross"    
# [11] "west dunbartonshire" "argyll & bute"       "dundee city"         "north lanarkshire"   "west lothian"        "eilean siar"         "east lothian"        "glasgow city"        "highland"            "shetland islands"   
# [21] "orkney islands"      "south lanarkshire"   "inverclyde"          "scottish borders"    "east renfrewshire"   "midlothian"          "renfrewshire"        "stirling"            "angus"               "moray"              
# [31] "east ayrshire"       "east dunbartonshire" "West Lothian"        "Edinburgh, City of"  "South Lanarkshire"   "Glasgow City"        "Inverclyde"          "East Dunbartonshire" "23"                  "Midlothian"         
# [41] "Angus"               "Perth & Kinross"     "Stirling"            "Fife"                "1"                   "Aberdeenshire"       "Falkirk"             "16"                  "17"                  "North Lanarkshire"  
# [51] "Dumfries & Galloway" "Aberdeen City"       "Highland"            "East Renfrewshire"   "Dundee City"         "11"                  "Clackmannanshire"    "East Ayrshire"       "East Lothian"        "Renfrewshire"       
# [61] "Scottish Borders"    "North Ayrshire"      "Moray"               "Orkney Islands"      "Argyll & Bute"       "Shetland Islands"    "14"                  "12"                  "10"                  "19"                 
# [71] "West Dunbartonshire" "Eilean Siar"         "South Ayrshire"      "15"                  "6"                   "27"                  "18"                  "20"                  "2"                   "29"                 
# [81] "13"                  "32"                  "30"                  "9"                   "25"                  "5"                   "4"                   "28"                  "3"                   "31"                 
# [91] "8"                   "26"                  "22"                  "7"                   "24"                  "21"                  NA                    "R"                   "Y"                   "L"                  
# [101] "P"                   "B"                   "C"                   "Q"                   "F"                   "K"                   "E"                   "O"                   "H"                   "V"                  
# [111] "A"                   "D"                   "T"                   "X"                   "M"                   "N"                   "U"                   "J"                   "S"                   "W"                  
# [121] "G"                   "Z"                   "I"                  
# 
# $hlth06
# [1] "grampian"                "ayrshire & arran"        "dumfries & galloway"     "fife"                    "lothian"                 "forth valley"            "tayside"                 "greater glasgow & clyde"
# [9] "highland"                "lanarkshire"             "western isles"           "shetland"                "orkney"                  "borders"                 "Lothian"                 "Lanarkshire"            
# [17] "Greater Glasgow & Clyde" "Tayside"                 "Forth Valley"            "Fife"                    "Grampian"                "Dumfries & Galloway"     "Highland"                "Ayrshire & Arran"       
# [25] "Borders"                 "Orkney"                  "Shetland"                "Western Isles"           NA                       
# 
# $hlth14
# [1] "S08000022" "S08000024" "S08000021" "S08000017" "S08000023" "S08000015" "S08000018" "S08000027" "S08000019" "S08000025" "S08000020" "S08000026" "S08000016" "S08000028" "13"        "16"        "7"         "3"        
# [19] "11"        "2"         "5"         "6"         "14"        "17"        "10"        "12"        "15"        "4"        
# 
# $hlthbd2014
# [1] "S08000023" "S08000021" "S08000020" "S08000024" "S08000027" "S08000022" "S08000019" "S08000015" "S08000016" "S08000018" "S08000028" "S08000025" "S08000017" "S08000026" "S08000029" "S08000030"
# 
# $hlthbd2019
...
# 
# $la
# [1] "P" "V" "O" "A" "N" "1" "X" "B" "5" "D" "M" "G" "Z" "3" "F" "R" "2" "K" "Y" "J" "L" "T" "H" "U" "4" "E" "Q" "C" "I" "S" "W" "6"
# 
# $la_code
# [1] "S12000029" "S12000018" "S12000038" "S12000011" "S12000046" "S12000034" "S12000040" "S12000041" "S12000017" "S12000030" "S12000039" "S12000005" "S12000010" "S12000028" "S12000026" "S12000015" "S12000042" "S12000044"
# [19] "S12000033" "S12000035" "S12000020" "S12000024" "S12000036" "S12000014" "S12000021" "S12000013" "S12000045" "S12000019" "S12000023" "S12000006" "S12000027" "S12000008"
# 
# $md04pc15
...
# 
# $md06quin
# [1] "2"                             "most deprived 20% data zones"  "4"                             "least deprived 20% data zones" "3"                             NA                             
# [7] "Least deprived 20% data zones" "Most deprived 20% data zones" 
# 
# $md09quin
# [1] "3"                             NA                              "4"                             "Most deprived 20% data zones"  "Least deprived 20% data zones" "2"                            
# 
# $md12quin
...
# 
# $outdoor
# [1] "Not at all"             "Several times a week"   "Once or twice a month"  "Once every 2-3 months"  "Every day"              NA                       "More than once per day" "Once or twice a year"  
# [9] "Once a week"           
# 
# $randgender
...
# 
# $serv3a
# [1] "very satisfied"                     "neither satisfied nor dissatisfied" "no opinion"                         "fairly satisfied"                   "fairly dissatisfied"                NA                                  
# [7] "very dissatisfied"                  "No opinion"                         "Fairly dissatisfied"                "Neither satisfied nor dissatisfied" "Fairly satisfied"                   "Very satisfied"                    
# [13] "Very dissatisfied"                 
# 
# $serv3e
# [1] "fairly satisfied"                   "neither satisfied nor dissatisfied" "no opinion"                         NA                                   "very satisfied"                     "fairly dissatisfied"               
# [7] "very dissatisfied"                  "No opinion"                         "Very satisfied"                     "Neither satisfied nor dissatisfied" "Fairly dissatisfied"                "Fairly satisfied"                  
# [13] "Very dissatisfied"                 
# 
# $sprt3aa
# [1] "no"                                                              "yes"                                                             NA                                                               
# [4] "refused"                                                         "No"                                                              "Yes"                                                            
# [7] "NOT A - Walking (at least 30 minutes for recreational purposes)" "A - Walking (at least 30 minutes for recreational purposes)"     "Walking"                                                        
# [10] "NOT Walking"     
###################################
