...
shes_results0 <- lapply(svy_results, arrow::read_parquet) %>% #read all the files in and store in a list
  bind_rows() # Sept 2026: n=1,011,168
...
shes_results1 <- shes_results0 %>% #n=1,011,168
